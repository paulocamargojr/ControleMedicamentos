...
namespace ControleMedicamentos.ConsoleApp.Compartilhado
{
    public class TelaMenuPrincipal
    {
        ...
        private RepositorioMedicamentos repositorioMedicamento;
        ...
        public TelaMenuPrincipal(Notificador notificador)
        {
            ...
            repositorioMedicamento = new RepositorioMedicamentos();
            ...
            telaCadastroRequisicao = new TelaCadastroRequisicao(repositorioRequisicao, notificador, repositorioMedicamento, repositorioPaciente, telaCadastroMedicamento, telaCadastroPaciente);
